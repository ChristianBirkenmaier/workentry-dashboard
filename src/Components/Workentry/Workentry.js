...
import { PROD_WORKENTRY_API, DEV_WORKENTRY_API, PROD_PROJECT_API, DEV_PROJECT_API } from "../../config/api.json";
...
export default function Workentry({ isDev }) {
    ...
    async function fetchData() {
        try {
            ...
            let [fetched_projects, workentries] = await Promise.all([fetch(projectUrl), fetch(workentryUrl)]);
            ...
            <Row className="data-header align-items-center">
                <Col className="list-header-row" sm={2}>
                    <Dropdown as={ButtonGroup} className="w-100">
                        ...
                        >
                            ...
                            {sort.name === "project.project" ? sort.asc ? sortAlphaDownIcon() : sortAlphaUpIcon() : <span>▵</span>}
                        </Button>
                    </Dropdown>
                </Col>
                <Col
                ...
                >
                    <Dropdown as={ButtonGroup} className="w-100">
                        ...
                        >
                            {sort.name === "category.category" ? sort.asc ? <span>▲</span> : <span>▼</span> : <span>▵</span>}
                        </Button>
                    </Dropdown>
                    {/* <Dropdown>
                ...
                >
                    <Dropdown as={ButtonGroup} className="w-100">
                        ...
                        >
                            {sort.name === "optionalText" ? sort.asc ? <span>▲</span> : <span>▼</span> : <span>▵</span>}
                        </Button>
                    </Dropdown>
                    {/* <Dropdown>
                        <Dropdown.Toggle variant="light" className="filter-button">
                ...
                <Col className="list-header-row" sm={1}>
                    <Dropdown as={ButtonGroup} className="w-100">
                        ...
                        >
                            {sort.name === "fromDate" ? sort.asc ? <span>▲</span> : <span>▼</span> : <span>▵</span>}
                        </Button>
                    </Dropdown>
                    {/* Von - Bis */}
                    {/* <Dropdown>
                ...
                <Col className="list-header-row" sm={1}>
                    <Dropdown as={ButtonGroup} className="w-100">
                        ...
                        >
                            {sort.name === "duration" ? sort.asc ? <span>▲</span> : <span>▼</span> : <span>▵</span>}
                        </Button>
                    </Dropdown>
                    {/* <Dropdown>
                        <Dropdown.Toggle variant="light" className="filter-button">
                ...
                <Row key={w._id} className="align-items-center">
                    ...
                    <Col sm={2}>
                        {!!updateData && w._id === updateData._id ? (
                            <InputGroup>
                                <FormControl value={updateData.project.project}></FormControl>
                            </InputGroup>
                        ) : w.project ? (
                            w.project.project
                        ) : (
                    ...
                    <Col sm={1}>
                        {!!updateData && w._id === updateData._id ? (
                            <InputGroup>
                                <FormControl value={updateData.fromDate}></FormControl>
                                <FormControl value={updateData.untilDate}></FormControl>
                            </InputGroup>
                        ) : (
