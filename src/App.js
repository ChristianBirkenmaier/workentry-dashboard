...
const WorkentriesComp = (
    <Workentry url="https://workentry-api.herokuapp.com/api/v1/workentry" />
);
    ...
    return (
        <div className="App">
            <Navbar bg="dark" variant="dark" style={{ top: 0 }}>
                <Nav>
                    <Nav.Link onClick={() => setActiveComponent(CategoryComp)}>
                        Categories
                    </Nav.Link>
                    <Nav.Link onClick={() => setActiveComponent(ProjectComp)}>
                        Projects
                    </Nav.Link>
                    <Nav.Link
                        onClick={() => setActiveComponent(WorkentriesComp)}
                    >
                        Workentries
                    </Nav.Link>
                    <Nav.Link
                        onClick={() => setActiveComponent(CreateWorkentryComp)}
                    >
                        New Workentry
                    </Nav.Link>
                </Nav>
